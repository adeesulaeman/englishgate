		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Grammar Section</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="text-center">
					<h2><span class="highlight">GRAMMAR</span></h2>					
				...
				<div id="grid-container" class="cbp-l-grid-projects">
					<ul>
						<li class="cbp-item graphic">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="img/Adjective.png" width="270px" height="180px" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="answers.php?code=GrammarAdjective" class="cbp-light cbp-l-caption-buttonRight">Assign</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item web-design logo">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="img/Adverb.png" width="270px" height="180px" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="answers.php?code=GrammarAdverb" class="cbp-light cbp-l-caption-buttonRight" data-title="World Clock Widget<br>by Paul Flavius Nechita">Assign</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item graphic logo">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="img/preposition.png" width="270px" height="180px" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
										
											<a href="answers.php?code=GrammarPreposition" class="cbp-light cbp-l-caption-buttonRight" data-title="To-Do Dashboard<br>by Tiberiu Neamu">Assign</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item web-design graphic">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="img/present_Artboard.png" width="270px" height="180px" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
										
											<a href="answers.php?code=GrammarSimple" class="cbp-light cbp-l-caption-buttonRight" data-title="Events and  More<br>by Tiberiu Neamu">Assign</a>
										</div>
									</div>
								</div>
							</div>
						...
						<!-- <li class="cbp-item identity web-design">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="img/5.jpg" width="270px" height="180px" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											
											<a href="answers.php?code=ReadingOccupation" class="cbp-light cbp-l-caption-buttonRight" data-title="Ski * Buddy<br>by Tiberiu Neamu">Assign</a>
										</div>
									</div>
								</div>
							</div> -->
