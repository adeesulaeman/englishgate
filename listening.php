		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Listening Section</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-10">
				<div class="text-center">
					<h2><span class="highlight">LISTENING</span></h2>					
				...
				<div id="grid-container" class="cbp-l-grid-projects">
					<ul>
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="answers.php?code=ListeningAnimal" class="cbp-light cbp-l-caption-buttonRight">Assign</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item web-design logo">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="answers.php?code=ListeningPlace" class="cbp-light cbp-l-caption-buttonRight" data-title="World Clock Widget<br>by Paul Flavius Nechita">Assign</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											...
											<a href="answers.php?code=ListeningThing" class="cbp-light cbp-l-caption-buttonRight" data-title="To-Do Dashboard<br>by Tiberiu Neamu">Assign</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item web-design graphic">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="img/4.jpg" width="270px" height="180px" alt="" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
										
											<a href="answers.php?code=ListeningPeople" class="cbp-light cbp-l-caption-buttonRight" data-title="Events and  More<br>by Tiberiu Neamu">Assign</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											...
											<a href="answers.php?code=ListeningOccupation" class="cbp-light cbp-l-caption-buttonRight" data-title="Ski * Buddy<br>by Tiberiu Neamu">Assign</a>
										</div>
									</div>
								</div>
							</div>
